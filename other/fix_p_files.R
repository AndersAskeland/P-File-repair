...
# Set file location
file_name <- "/Users/andersaskeland/Documents/Statistics (Local)/GE_MRI/folder_p-file_test/P04608.7" # v. 28 (20 coils)
...
file_name <- "~/Documents/Statistics (Local)/GE_MRI/folder_p-file_test/P06656.7"
file_output <- "~/Documents/Statistics (Local)/GE_MRI/folder_p-file_test/P06656_fixed_r.7"


file_name <- "/Users/andersaskeland/Documents/Statistics (Local)/GE_MRI/170180-1462/P56320.7" # v. 27 - Working (32 coils)
...
empty_values <- abs(surpluess_data_points / coils)
...
for (i in 1:coils){
  ...
  # Add data
  dat <- raw_data[round(min_line):round(max_line)]
  print(paste(i, "Min line:", round(min_line)))
  print(paste(i, "Max line:", round(max_line)))

  print(paste(i, "Raw data min:", raw_data[round(min_line)]))
  print(paste(i, "Raw data max:", raw_data[round(max_line)]))
  print(paste(i, "Raw data max + 1:", raw_data[round(max_line) + 1]))
